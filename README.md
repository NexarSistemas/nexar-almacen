...
|---------|-------|------|-------------|
| **1.7.12** | 2026-05-01 | Corrección / Mejora | Búsqueda e importación individual desde OpenFoodFacts por código de barras o nombre, con fallback ante errores temporales |
